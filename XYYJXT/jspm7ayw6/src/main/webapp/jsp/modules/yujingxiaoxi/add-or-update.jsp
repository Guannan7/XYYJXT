						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>消息内容</label>
										<textarea  name="xiaoxineirong" class="form-control" id="xiaoxineirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>发送时间</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("yujingxiaoxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yujingxiaoxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yujingxiaoxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#xiaoxineirong").val(ruleForm.xiaoxineirong);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xiaoxineirong != null && res.data.xiaoxineirong != ''){

						$("#xiaoxineirong").val(res.data.xiaoxineirong);
					}
